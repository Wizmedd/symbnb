...
class BookingType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('comment', TextareaType::class, $this->getConfiguration(false, "Si vous avez des commentaires ou des questions n'hésitez pas à nous en faire part", ['required' => false]));
