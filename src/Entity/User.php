...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min = 10, minMessage = "Votre numéro de téléphone doit posséder au mininum 10 chiffres")
     * @Assert\Length(max=10, maxMessage = "Votre numéro de téléphone doit posséder au maximum 10 chiffres")
     * @Assert\Regex(pattern="/^[0-9]*$/", message="votre numéro doit posséder uniquement des chiffres")
     */
    private $phone;
    ...
    {
        //le Salt est déjà dans bcrypt
    }

    public function getUsername()
    {
        //On se log avec l'email
        return $this->email;
    }
